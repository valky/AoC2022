...
//var scanTestP1 = new Scan(testCave);
//scanTestP1.SimulateSandDrops();
//scanTestP1.DrawCave();
//Console.WriteLine($"TestP1 : {scanTestP1.CaveScan.Sands.Count() }");
...
internal class Cave
{
    ...
    internal TypeOfPoint AnalysePoint(Point point)
        => point switch
        {
            ...
            Point p when p.Y == this.Size.Item2.Y + 2 => TypeOfPoint.Floor,
            _ => TypeOfPoint.Air,
        };
...
internal class Scan
{
    ...
    internal void DrawCave()
    {
        ...
        int XMin = startPoint.X - 20;
        int YMin = startPoint.Y;

        int XMax = endPoint.X + 20;
        int YMax = endPoint.Y;
        ...
        foreach (var y in Enumerable.Range(0, YMax + 3))
        {
    ...
    internal void SimulateSandDrops()
    {
        ...
        while ( endPoint.Y < CaveScan.Size.Item2.Y + 2  && endPoint.Y != 0);
    }
    ...
    private Point? GetNextPoint(Point point, Direction direction)
        ...
        {
            true when point.Y > CaveScan.Size.Item2.Y + 2 => null,
