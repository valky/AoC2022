...
internal class Scan
{
    ...
    { 
        ...
        do
        {
            var nextPoint = new Point(sand.X, sand.Y + 1);


            switch (CaveScan.AnalysePoint(nextPoint))
            {
                case TypeOfPoint.Air:
                case TypeOfPoint.SandStart:
                    sand = nextPoint;
                    break;
                case TypeOfPoint.Rock:
                    fall = false;
                    break;
                case TypeOfPoint.Sand:
                    fall = false;
                    break;
                default:
                    throw new Exception("Meme un grain de sable peux bloquer une rolex");
            }
        }
        while (fall);
